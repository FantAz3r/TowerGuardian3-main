...
namespace TowerGuardian.Scripts.GamePlayElements.Envitoment.GameObjects
{
    public class Tower : MonoBehaviour, ISceneContainer
    {
        ...
        public Platform ShopPlatform { get; private set; }

        [field: SerializeField]
        public TowerDoor Door { get; private set; }

        [field: SerializeField]
        public StairsTrigger StairsFirstFloor { get; private set; }

        [field: SerializeField]
        public TowerRenderer TowerRenderer { get; private set; }
