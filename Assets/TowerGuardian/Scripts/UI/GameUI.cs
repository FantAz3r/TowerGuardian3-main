...
namespace TowerGuardian.Scripts.UI
{
    public class GameUI : MonoBehaviour
    {
        ...
        [field: SerializeField]
        public SaleWindow Sell { get; private set; }

        [field: SerializeField]
        public LouseLevelMenu LouseLevelMenu { get; private set; }

        [field: SerializeField]
        public ScoreViewer LouseScoreViewer { get; private set; }

        [field: SerializeField]
        public StartLevelMenu StartLevelMenu { get; private set; }

        [field: SerializeField]
        public ScoreViewer StartScoreViewer { get; private set; }

        [field: SerializeField]
        public WinLevelMenu WinLevelMenu { get; private set; }

        [field: SerializeField]
        public ScoreViewer WinScoreViewer { get; private set; }
        ...
        [field: SerializeField]
        public CardSelectionMenu CardSelectionMenu { get; private set; }

        [field: SerializeField]
        public ShowCardsButton ShowCardsButton { get; private set; }

        [field: SerializeField]
        public List<CardButton> CardButtons { get; private set; }
