...
namespace TowerGuardian.Scripts.StaticData.Configs.AbilityConfigs
{
    ...
    {
        [SerializeField]
        private float _exploadDamage = 10f;
        [SerializeField]
        private float _maxFlyDistance = 15f;
        [SerializeField]
        private float _exploadRange = 5f;
        [SerializeField]
        private float _flySpeed = 20f;
        [SerializeField]
        private float _cooldown = 20f;
        [SerializeField]
        private float _minCooldown = 2.5f;

        [SerializeField]
        private float _cooldownPerLevel = 1f;
        [SerializeField]
        private float _damagePerLevel = 2f;
        [SerializeField]
        private float _distancePerLevel = 1f;

        [field: SerializeField]
        public Fireball FireballPrefab { get; private set; }
