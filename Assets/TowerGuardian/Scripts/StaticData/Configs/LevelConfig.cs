...
namespace TowerGuardian.Scripts.StaticData.Configs
{
    ...
    public class LevelConfig : ScriptableObject
    {
        ...
        [SerializeField]
        private LevelID _level = LevelID.Level1;
        [SerializeField]
        private List<QuestType> _quests;
        [SerializeField]
        private Vector3 _playerSpawnPoint;

        [Header("Day Phase Settings")]
        [SerializeField]
        private float _dayDuration = 15f;
        [SerializeField]
        private float _nightDuration = 15f;
        [SerializeField]
        private float _dayLightIntensity = 1f;
        [SerializeField]
        private float _nightLightIntensity = 0.2f;
        [SerializeField]
        private float _transitionDuration = 2f;
        [SerializeField]
        private Color _dayLightColor = Color.white;
        [SerializeField]
        private Color _nightLightColor = Color.black;
        ...
        [SerializeField]
        private float _scorePerTimeOneStar;
        [SerializeField]
        private float _scorePerTimeTwoStar;
        [SerializeField]
        private float _scorePerTimeThreeStar;
