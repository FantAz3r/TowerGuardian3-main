...
public class QuestConfig : ScriptableObject
{
    ...
    [field: SerializeField] public string MobileDescriptionRU { get; private set; }
    [field: SerializeField] public string MobileDescriptionEN { get; private set; }
    [field: SerializeField] public string MobileDescriptionTR { get; private set; }
    [field: SerializeField] public QuestType QuestType { get; private set; }
    [field: SerializeField] public bool IsProgressQuest { get; private set; }

    [field: SerializeField] public int TargetValue { get; private set; }
    [field: SerializeField] public bool IsTimeQuest { get; private set; }
